...
public class ActionNodeWindow : EditorWindow
{
    string className = "";
    ...
    public void Init(string className)
    {
        ...
        if (className.Contains("ActionNode"))
        {
            int idx = className.IndexOf("ActionNode", StringComparison.Ordinal);
    ...
    private void OnGUI()
    {
        ...
        string path = "Assets/BehaviourTree/Scripts/ActionNodes/" + className;
        ...
        if (GUILayout.Button("Create New Script"))
        {
            ...
            {
                string templatePath = "Assets/BehaviourTree/Templates/ActionNodeTemplate.txt";
