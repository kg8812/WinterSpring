Shader "WinterSpring/Environment"
{
    Properties
    {
        ...
        SubShader
            {
                ...
                Pass
                {
                    ...
                    half4 CombinedShapeLightFragment(Varyings i) : SV_Target
                    {
                        ...
                        float4 MaskTex = SAMPLE_TEXTURE2D(_MaskTex, sampler_MaskTex, uv_main);
                        ...
                        const half4 main = i.color * SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, uv_main + NormalOutput * MaskTex.r);
                        SurfaceData2D surfaceData;
                        InputData2D inputData;

                        InitializeSurfaceData(main.rgb, main.a, MaskTex, surfaceData);
