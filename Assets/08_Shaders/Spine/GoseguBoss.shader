Shader "Universal Render Pipeline/2D/Custom/GoseguBoss" {
    Properties{
        ...
        SubShader{
            ...
            half4 frag(VertexOutput i) : SV_Target{
                ...
                half4 mask = lerp(0, tex2D(_MaskTex, i.uv0), _HDRSwitch);
                float4 texColor = tex2D(_MainTex, i.uv0) * lerp(1, _HDRColor + sin(_Time.y * 2) * 0.5 + 0.5, mask.r);
