Shader "Universal Render Pipeline/2D/Custom/NightWeapon"
{
    Properties
    {
        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            half4 UnlitFragment(Varyings i) : SV_Target
            {
                ...
                float2 NormalOutput = NormalTex.xy * _Normal_Strength * float2(saturate(i.uv.x - 0.3)*4, 0);

                float4 addNormalMainTex = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, uv_main + NormalOutput);

                mainTex = addNormalMainTex;
